STRINGS_EN = {
    ...
    options_reset_colors_button = "Clic to reset colors",
    options_reset_colors_button_confirm = "Sure? Clic again to reset colors",
...
STRINGS_FR = {
    ...
    options_reset_colors_button = "Cliquez pour réinitialiser les couleurs",
    options_reset_colors_button_confirm = "Sûr·e ? Cliquez à nouveau pour valider",
